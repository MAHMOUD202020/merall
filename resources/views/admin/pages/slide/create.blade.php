...
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{route('admin.slide.index')}}">الشرائح</a></li>
    <li class="breadcrumb-item active" aria-current="page"><span>اضافة شريحة</span></li>
@endsection
                    ...
                    <div class="widget-header">
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                <h4>اضافة شريحة جديد</h4>
                            </div>
                        </div>
                    </div>
                    <div class="widget-content widget-content-area">
                        @include('admin.inc.form.slide_create')
                    </div>
                </div>
            </div>
        </div>
