...
@section('breadcrumb')
    <li class="breadcrumb-item active" aria-current="page"><span>المنتجات</span></li>
@endsection
...
@section('content')
    ...
    {!! myDataTable_table([
        ...
        "name"       => 'الاسم',
        "slug"       => 'slug',
        "img"        => ['الصورة', false , false , "all" , 'notExport'],
        "price"      => 'السعر',
        "discount"   => 'الخصم',
        "premium"    => 'نوع المنتج',
    ...
    <script>
        ...
        myDataTableColumns({
            ...
            btn :  {
                ...
                'show': '{{url('admin/product/{id}')}}',
                'open': ['{{url('product/{slug}')}}' , 'فتح الرابط'],
                'delete': '{{url('admin/product/{id}')}}',
                'print': '#',
            }
        })
    </script>
