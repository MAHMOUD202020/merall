...
if (!function_exists('myDataTable_table')){
    ...
    function myDataTable_table(  $columns = ['id']   , $theme = 3 , $action = true , $tdOne=true , $classTable=null){
        ...
        $action = $action === true ? " <th scope='col' class='th-action notExport'>  التحكم <div class='form-group input-search'><input type='text' name='".$columnName."' class='form-control invisible'  autocomplete='off' placeholder='....'></div></th>" : "";
